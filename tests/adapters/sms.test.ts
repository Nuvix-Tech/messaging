...
import { assertSuccessfulSendResult, assertFailedSendResult, isValidPhoneNumber, generateTestId } from '../utils';
...
describe('SMS Adapters', () => {
  ...
  beforeEach(() => {
    ...
    testSMSMultipleRecipients = new SMSMessage({
      to: [testConfig.twilio.testPhoneNumber, testConfig.vonage.testPhoneNumber],
  ...
  describe('SMS Message Validation', () => {
    ...
    test('should create SMS with array constructor', () => {
      const sms = new SMSMessage(['+1234567890'], 'Test message', '+0987654321');
